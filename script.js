document.addEventListener('DOMContentLoaded', function () {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        ...
        if (field.type === 'email' && !isValidEmail(value)) {
          ...
          errorMessage = getFieldLabel(field, name) + ' must be at least ' + field.minLength + ' characters.';
        } else if (field.maxLength && field.maxLength > 0 && value.length > field.maxLength) {
          errorMessage = getFieldLabel(field, name) + ' must not exceed ' + field.maxLength + ' characters.';
        } else if (field.pattern) {
          const pattern = new RegExp('^(?:' + field.pattern + ')$');
          if (!pattern.test(value)) {
            errorMessage = getFieldLabel(field, name) + ' format is invalid.';
          }
        }
      }
  ...
  function handleFormSuccess(form) {
    ...
    setTimeout(function () {
      const msg = form.querySelector('.form-success-message');
      if (msg) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Pinky's משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'e8b48a0b-65d2-4843-97fd-e399d0867ef8',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'e8b48a0b-65d2-4843-97fd-e399d0867ef8';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e8b48a0b-65d2-4843-97fd-e399d0867ef8';
